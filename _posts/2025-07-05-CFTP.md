...
\begin{equation}
r(G_{K,p})\leq \nu(K)+\mathrm{dim}_{\mathbb{F}_p}\mathrm{C}^{p}_K(K)-1.
\end{equation}

Assuming 
\begin{equation}
\mathrm{dim}_{\mathbb{F}_p}\mathrm{Cl}^{p}_K(K)>2+2\sqrt{\nu(k)+1},
\end{equation}

we obtain 
\begin{equation}
\frac{(\mathrm{dim}_{\mathbb{F}_p}\mathrm{C}^{p}_K(K))^2}{4}>\frac{(2+2\sqrt{\nu(K)+1})^2}{4}
\end{equation}
\begin{equation}
=2+2\sqrt{\nu(K)+1}+\nu(K)+1
\end{equation}
\begin{equation}
=\mathrm{dim}_{\mathbb{F}_p}\mathrm{Cl}^{p}_K(K)+\nu(K)+1
\end{equation}
\begin{equation}
>r(G_{K,p}),
\end{equation}
