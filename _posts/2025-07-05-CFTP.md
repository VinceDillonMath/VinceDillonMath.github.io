...
\end{equation}
 ...
 is *p-elementary*. Construct the $p$-class field tower as before. Since every $p$-elementary group is in particular abelian, it follows that $\mathbb H_p(K)\leq \mathbb H(K)$. Hence, if the $p$-tower never stabilizes, neither does the standard tower.
...
\begin{equation}
r(G_{K,p})\leq d(G_{K,p})^2/4= (\mathrm{dim}_{\mathbb{F}_p} \mathrm{C}^{p}_{K}(K))^2/4.
\end{equation}

By the previous theorem, we have 
\begin{equation}
r(G_{K,p})\leq \nu(K)+\mathrm{dim}_{\mathbb{F}_p}\mathrm{C}^{p}_{K}(K)-1.
\end{equation}

Assuming 
\begin{equation}
\mathrm{dim}_{\mathbb{F}_p}\mathrm{Cl}^{p}_{K}(K)>2+2\sqrt{\nu(k)+1},
\end{equation}

we obtain 
\begin{equation}
\frac{(\mathrm{dim}_{\mathbb{F}_p}\mathrm{C}^{p}_{K}(K))^2}{4}>\frac{(2+2\sqrt{\nu(K)+1})^2}{4}
\end{equation}
\begin{equation}
=2+2\sqrt{\nu(K)+1}+\nu(K)+1
\end{equation}
\begin{equation}
=\mathrm{dim}_{\mathbb{F}_p}\mathrm{Cl}^{p}_{K}(K)+\nu(K)+1
\end{equation}
\begin{equation}
\geq r(G_{K,p}),
\end{equation}
